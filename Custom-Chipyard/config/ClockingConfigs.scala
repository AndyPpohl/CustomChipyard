...
//import freechips.rocketchip.subsystem.{AsynchronousCrossing, RocketCrossingParams, SBUS}
...
class DefaultClockingRocketConfig extends Config(
  ...
  //new freechips.rocketchip.rocket.WithNHugeCores( n = 1, location = SBUS, crossing = RocketCrossingParams(AsynchronousCrossing()) ) ++

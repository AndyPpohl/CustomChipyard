...
module INToRecFN_i16_e8_s24(	// @[generators/hardfloat/hardfloat/src/main/scala/INToRecFN.scala:43:7]
  ...
  wire [15:0] intAsRawFloat_absIn = io_in[15] ? 16'h0 - io_in : io_in;	// @[generators/hardfloat/hardfloat/src/main/scala/rawFloatFromIN.scala:51:34, :52:{24,31}]
  ...
  RoundAnyRawFNToRecFN_ie5_is16_oe8_os24 roundAnyRawFNToRecFN (	// @[generators/hardfloat/hardfloat/src/main/scala/INToRecFN.scala:60:15]
    ...
    .io_in_sign   (io_in[15]),	// @[generators/hardfloat/hardfloat/src/main/scala/rawFloatFromIN.scala:51:34]

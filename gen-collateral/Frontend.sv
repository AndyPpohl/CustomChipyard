...
module Frontend(	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7]
  ...
  wire [39:0] predicted_npc = {s1_pc[39:2], 2'h0} + 40'h4;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:115:18, :129:25]
  ...
  assign _io_cpu_npc_T = io_cpu_req_valid ? io_cpu_req_bits_pc[39:1] : s2_replay ? s2_pc[39:1] : predicted_npc[39:1];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14, :117:22, :129:25, :134:46, :135:16, :186:28]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7]
        ...
        s2_tlb_resp_miss = _RANDOM[4'h4][11];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :121:24]
        s2_tlb_resp_pf_inst = _RANDOM[4'h6][23];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :121:24]
        s2_tlb_resp_ae_inst = _RANDOM[4'h6][29];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :121:24]
        s2_tlb_resp_cacheable = _RANDOM[4'h7][1];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :121:24]
        s2_speculative = _RANDOM[4'h7][11];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :121:24, :123:31]
        s2_replay_REG = _RANDOM[4'h7][30];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :121:24, :134:56]
        recent_progress_counter = {_RANDOM[4'h7][31], _RANDOM[4'h8][0]};	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :121:24, :155:40]
        fq_io_enq_valid_REG = _RANDOM[4'h8][1];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :155:40, :184:29]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ICache icache (	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:70:26]
    ...
    .io_s1_kill                     (io_cpu_req_valid | _tlb_io_resp_miss | s2_replay),	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:105:19, :134:46, :178:{36,56}]
  ...
  ShiftQueue fq (	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:91:64]
    ...
    .io_enq_bits_replay       (icache_io_s2_kill & ~_icache_io_resp_valid & ~_s2_xcpt_T | _fq_io_enq_bits_replay_T_5),	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:70:26, :122:37, :180:71, :184:112, :190:{77,80,102,105,115}]

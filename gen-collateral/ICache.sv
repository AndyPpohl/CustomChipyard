...
module ICache(	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7]
  ...
  wire        _tag_rdata_T;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:426:42]
  ...
  wire [25:0] _rockettile_icache_tag_array_0_RW0_rdata;	// @[generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
  ...
  assign _tag_rdata_T = io_req_bits_addr[6];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:426:42]
  ...
  reg  [1:0]  vb_array;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:448:25]
  wire [1:0]  _s1_vb_T_1 = vb_array >> io_s1_paddr[6];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:448:25, :508:25, :859:21]
  wire        s1_hit = _s1_vb_T_1[0] & _rockettile_icache_tag_array_0_RW0_rdata[24:0] == io_s1_paddr[31:7];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:361:40, :493:30, :508:25, :514:{26,33}, generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26, generators/rocket-chip/src/main/scala/util/package.scala:163:13]
  assign wen = refill_one_beat & ~invalidated;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:367:24, :391:39, :570:{32,35}]
  wire [3:0]  _GEN = {refill_paddr[6], 3'h0};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :386:31, :574:67, :859:21]
  ...
  wire [3:0]  _vb_array_T_3 = 4'h1 << refill_paddr[6];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:386:31, :452:32, :859:21]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7]
      ...
      vb_array <= 2'h0;	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:448:25]
    end
      ...
      if (io_invalidate)	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:256:14]
        ...
        vb_array <= writeEnable_0 & ~invalidated ? vb_array | _vb_array_T_3[1:0] : ~(~vb_array | _vb_array_T_3[1:0]);	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:367:24, :399:37, :448:25, :452:{32,72,75}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:233:22]
    end
    ...
    if (s1_valid) begin	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:341:25]
      ...
      s2_tl_error <= s1_hit & _rockettile_icache_tag_array_0_RW0_rdata[25];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:361:40, :518:32, :615:30, generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26, generators/rocket-chip/src/main/scala/util/package.scala:163:13]
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7]
    ...
    logic [31:0] _RANDOM[0:6];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7]
    initial begin	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7]
        ...
        s1_valid = _RANDOM[3'h0][4];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :341:25]
        s2_valid = _RANDOM[3'h1][12];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :363:25]
        s2_hit = _RANDOM[3'h1][13];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :363:25, :364:23]
        invalidated = _RANDOM[3'h1][14];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :363:25, :367:24]
        refill_valid = _RANDOM[3'h1][15];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :363:25, :368:29]
        s2_request_refill_REG = _RANDOM[3'h1][18];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :363:25, :385:45]
        refill_paddr = {_RANDOM[3'h1][31:19], _RANDOM[3'h2][18:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :363:25, :386:31]
        r_counter = {_RANDOM[3'h3][31:26], _RANDOM[3'h4][2:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        accruedRefillError = _RANDOM[3'h4][3];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :428:31, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        vb_array = _RANDOM[3'h4][5:4];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :448:25, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        s2_dout_0 = {_RANDOM[3'h5][31:14], _RANDOM[3'h6][13:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :612:26]
        s2_tl_error = _RANDOM[3'h6][15];	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:251:7, :612:26, :615:30]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  rockettile_icache_tag_array_0 rockettile_icache_tag_array_0 (	// @[generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    .RW0_addr  (writeEnable_0 ? refill_paddr[6] : _tag_rdata_T),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:386:31, :399:37, :426:42, :859:21, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:233:22, generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    ...
    .RW0_wdata ({refillError, refill_paddr[31:7]}),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:386:31, :388:33, :430:43, :435:34]
  ...
  rockettile_icache_data_arrays_0_0 rockettile_icache_data_arrays_0_0 (	// @[generators/rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? _GEN | refill_cnt[3:0] : io_req_bits_addr[6:3]),	// @[generators/rocket-chip/src/main/scala/rocket/ICache.scala:391:39, :565:31, :574:{10,67}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:234:25]

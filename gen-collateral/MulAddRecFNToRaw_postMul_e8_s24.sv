...
module MulAddRecFNToRaw_postMul_e8_s24(	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7]
  ...
  wire [2:0]   _sigSum_T_3 = io_mulAddResult[48] ? io_fromPreMul_highAlignedSigC[2:0] + 3'h1 : io_fromPreMul_highAlignedSigC[2:0];	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:172:16, :192:{16,32}, :193:47]
  ...
  wire         _notNaN_addZeros_T = io_fromPreMul_isZeroA | io_fromPreMul_isZeroB;	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:267:32]
  assign io_invalidExc = io_fromPreMul_isSigNaNAny | io_fromPreMul_isInfA & io_fromPreMul_isZeroB | io_fromPreMul_isZeroA & io_fromPreMul_isInfB;	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7, :271:35, :272:{31,57}, :273:32]
  assign io_rawOut_isNaN = io_fromPreMul_isNaNAOrB;	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7]
  assign io_rawOut_isInf = notNaN_isInfProd;	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7, :264:49]
  assign io_rawOut_isZero = _notNaN_addZeros_T | notCDom_completeCancellation;	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7, :255:50, :267:32, :282:25]
  assign io_rawOut_sign = notNaN_isInfProd & io_fromPreMul_signProd | _notNaN_addZeros_T & io_fromPreMul_signProd & (io_fromPreMul_signProd ^ io_fromPreMul_doSubMags) | ~notNaN_isInfProd & ~_notNaN_addZeros_T & ~notCDom_completeCancellation & (io_fromPreMul_signProd ^ _sigSum_T_3[2]);	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7, :190:42, :192:16, :232:36, :255:50, :257:12, :259:36, :264:49, :267:32, :285:27, :286:43, :287:48, :288:36, :290:50, :291:{10,28,31,49}]
  assign io_rawOut_sExp = io_fromPreMul_sExpSum - {4'h0, notCDom_normDistReduced2, 1'h0};	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7, :241:46, src/main/scala/chisel3/util/Mux.scala:50:70]
  assign io_rawOut_sig = {_notCDom_mainSig_T[51:26], |{_notCDom_mainSig_T[25:23], {|{|(notCDom_absSigSum[23:22]), |(notCDom_absSigSum[21:20])}, |{|(notCDom_absSigSum[19:18]), |(notCDom_absSigSum[17:16])}, |{|(notCDom_absSigSum[15:14]), |(notCDom_absSigSum[13:12])}, |{|(notCDom_absSigSum[11:10]), |(notCDom_absSigSum[9:8])}, |{|(notCDom_absSigSum[7:6]), |(notCDom_absSigSum[5:4])}, |{|(notCDom_absSigSum[3:2]), |(notCDom_absSigSum[1:0])}} & {notCDom_reduced4SigExtra_shift[1], notCDom_reduced4SigExtra_shift[2], notCDom_reduced4SigExtra_shift[3], notCDom_reduced4SigExtra_shift[4], notCDom_reduced4SigExtra_shift[5], notCDom_reduced4SigExtra_shift[6]}}};	// @[generators/hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:169:7, :234:12, :243:{27,50}, :247:{39,78}, :249:11, :251:{12,28}, :252:{28,35,39}, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:76:56, :77:20, :78:22, :103:{33,54}]
endmodule

...
module MultiHeadedQueue(	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
  ...
  wire        _raddr_T_11 = 1'h1 - raddr;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:23:22, generators/gemmini/src/main/scala/gemmini/Util.scala:13:57]
  wire        _io_deq_bits_1_T_19 = raddr ? 1'h1 - _raddr_T_11 - 1'h1 : raddr - 1'h1;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:23:22, generators/gemmini/src/main/scala/gemmini/Util.scala:13:{10,48,57,62,71}]
  wire [1:0]  _GEN = {1'h0, io_deq_pop};	// @[generators/gemmini/src/main/scala/gemmini/Util.scala:13:22]
  ...
  `endif // not def SYNTHESIS
  wire        _len_T_4 = ~(len[1]) & io_enq_valid;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:25:20, :27:23, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  always @(posedge clock) begin	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
    ...
    if (reset) begin	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
      raddr <= 1'h0;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:23:22]
      waddr <= 1'h0;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:24:22]
      ...
      if (io_deq_pop) begin	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:8:14]
        raddr <= raddr >= 1'h1 - io_deq_pop - 1'h1 & io_deq_pop ? io_deq_pop - _raddr_T_11 - 1'h1 : raddr + io_deq_pop;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:23:22, generators/gemmini/src/main/scala/gemmini/Util.scala:13:{10,13,22,26,32,48,57,62,71}]
        len <= len - _GEN + {1'h0, _len_T_4};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:25:20, :45:{16,29}, generators/gemmini/src/main/scala/gemmini/Util.scala:13:22, src/main/scala/chisel3/util/Decoupled.scala:51:35]
      end
      else if (_len_T_4)	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
        len <= len + 2'h1;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:25:20, :39:16]
      if (_len_T_4) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
        if (waddr)	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:24:22]
          waddr <= 1'h1 - (1'h1 - waddr) - 1'h1;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:24:22, generators/gemmini/src/main/scala/gemmini/Util.scala:13:{48,57,62}]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
    ...
    logic [31:0] _RANDOM[0:17];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
    initial begin	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
        ...
        regs_0_cmd_inst_funct = _RANDOM[5'h0][6:0];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_0_cmd_rs1 = {_RANDOM[5'h1], _RANDOM[5'h2]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_0_cmd_rs2 = {_RANDOM[5'h3], _RANDOM[5'h4]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_0_rob_id_bits = _RANDOM[5'h8][12:10];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_1_cmd_inst_funct = _RANDOM[5'h8][21:15];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_1_cmd_rs1 = {_RANDOM[5'h9][31:15], _RANDOM[5'hA], _RANDOM[5'hB][14:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_1_cmd_rs2 = {_RANDOM[5'hB][31:15], _RANDOM[5'hC], _RANDOM[5'hD][14:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_1_rob_id_bits = _RANDOM[5'h10][27:25];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        raddr = _RANDOM[5'h10][30];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17, :23:22]
        waddr = _RANDOM[5'h10][31];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17, :24:22]
        len = _RANDOM[5'h11][1:0];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :25:20]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_enq_ready = ~(len[1]);	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :25:20, :27:23]
  assign io_deq_valid_0 = |len;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :25:20, :31:28]
  assign io_deq_valid_1 = len[1];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :25:20, :31:28]
  assign io_deq_bits_0_cmd_inst_funct = raddr ? regs_1_cmd_inst_funct : regs_0_cmd_inst_funct;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17, :23:22, :32:20]
  assign io_deq_bits_0_cmd_rs1 = raddr ? regs_1_cmd_rs1 : regs_0_cmd_rs1;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17, :23:22, :32:20]
  assign io_deq_bits_0_cmd_rs2 = raddr ? regs_1_cmd_rs2 : regs_0_cmd_rs2;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17, :23:22, :32:20]
  assign io_deq_bits_0_rob_id_bits = raddr ? regs_1_rob_id_bits : regs_0_rob_id_bits;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17, :23:22, :32:20]
  assign io_deq_bits_1_cmd_inst_funct = _io_deq_bits_1_T_19 ? regs_1_cmd_inst_funct : regs_0_cmd_inst_funct;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17, :32:20, generators/gemmini/src/main/scala/gemmini/Util.scala:13:10]
  assign io_deq_bits_1_cmd_rs1 = _io_deq_bits_1_T_19 ? regs_1_cmd_rs1 : regs_0_cmd_rs1;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17, :32:20, generators/gemmini/src/main/scala/gemmini/Util.scala:13:10]
  assign io_deq_bits_1_cmd_rs2 = _io_deq_bits_1_T_19 ? regs_1_cmd_rs2 : regs_0_cmd_rs2;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17, :32:20, generators/gemmini/src/main/scala/gemmini/Util.scala:13:10]
  assign io_deq_bits_1_rob_id_bits = _io_deq_bits_1_T_19 ? regs_1_rob_id_bits : regs_0_rob_id_bits;	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17, :32:20, generators/gemmini/src/main/scala/gemmini/Util.scala:13:10]
endmodule

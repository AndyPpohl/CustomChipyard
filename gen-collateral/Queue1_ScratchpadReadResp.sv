...
module Queue1_ScratchpadReadResp(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input  [15:0] io_enq_bits_data,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input         io_deq_ready,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output        io_deq_valid,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output [15:0] io_deq_bits_data,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  reg  [16:0] ram;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  always @(posedge clock) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
    if (do_enq)	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35, :263:27, :298:17, :301:{26,35}]
      ram <= {1'h1, io_enq_bits_data};	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
        ...
        ram = _RANDOM[/*Zero width*/ 1'b0][17:1];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  ...
  assign io_deq_bits_data = full ? ram[15:0] : io_enq_bits_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :259:27, :293:17, :298:17, :299:19]
  assign io_deq_bits_fromDMA = ~full | ram[16];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :259:27, :261:28, :293:17, :298:17, :299:19]

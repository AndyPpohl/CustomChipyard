...
module Queue2_NormalizedInput(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input  [15:0] io_enq_bits_acc_read_resp_data_0_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input  [15:0] io_enq_bits_acc_read_resp_data_1_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  input  [15:0] io_enq_bits_acc_read_resp_igelu_qb,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input  [15:0] io_enq_bits_acc_read_resp_igelu_qc,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input  [15:0] io_enq_bits_acc_read_resp_iexp_qln2,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input  [15:0] io_enq_bits_acc_read_resp_iexp_qln2_inv,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  input  [1:0]  io_enq_bits_len,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output [15:0] io_deq_bits_acc_read_resp_data_0_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output [15:0] io_deq_bits_acc_read_resp_data_1_0,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  ram_2x67 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_acc_read_resp_acc_bank_id, io_enq_bits_acc_read_resp_scale_bits, io_enq_bits_acc_read_resp_fromDMA, io_enq_bits_acc_read_resp_data_1_0, io_enq_bits_acc_read_resp_data_0_0})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_acc_read_resp_data_0_0 = _ram_ext_R0_data[15:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_acc_read_resp_data_1_0 = _ram_ext_R0_data[31:16];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_acc_read_resp_fromDMA = _ram_ext_R0_data[32];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_acc_read_resp_scale_bits = _ram_ext_R0_data[64:33];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_acc_read_resp_acc_bank_id = _ram_ext_R0_data[66:65];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule

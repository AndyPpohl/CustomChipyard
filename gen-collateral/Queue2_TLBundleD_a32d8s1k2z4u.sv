...
module Queue2_TLBundleD_a32d8s1k2z4u(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  ram_2x18 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_corrupt, io_enq_bits_data, io_enq_bits_denied, io_enq_bits_source, io_enq_bits_size, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[7];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_denied = _ram_ext_R0_data[8];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_data = _ram_ext_R0_data[16:9];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[17];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule

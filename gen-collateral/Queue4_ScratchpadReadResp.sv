...
module Queue4_ScratchpadReadResp(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  ram_4x17 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_fromDMA, io_enq_bits_data})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[15:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_fromDMA = _ram_ext_R0_data[16];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule

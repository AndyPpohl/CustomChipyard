...
module ram_6x5(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input  [2:0] R0_addr,
  input        R0_en,
  input        R0_clk,
  output [4:0] R0_data,
  ...
  reg [4:0] Memory[0:5];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        for (logic [2:0] i = 3'h0; i < 3'h6; i += 3'h1) begin
          ...
          Memory[i] = _RANDOM_MEM[4:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        end
